...
export interface TimelineEntry {
  id:string; date:string; year:string; name:string; body:string; status:EntryStatus
}

export const timeline: TimelineEntry[] = [
  { id:'np-backend', date:'Apr 2026', year:'MMXXVI · 2026',
    ...
    status:'active' },
  { id:'lead-agent', date:'Mar 2026', year:'MMXXVI · 2026',
    ...
    status:'active' },
  { id:'graphy', date:'Dec 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'airhandler', date:'Nov 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'sentinel', date:'Oct 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'vesper', date:'Sep 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'woo', date:'Aug 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'moviemate', date:'Jul 2025', year:'MMXXV · 2025',
    ...
    status:'deployed' },
  { id:'saas', date:'Q3 2026', year:'Upcoming Operations',
    ...
    status:'upcoming' },
  { id:'classified-op', date:'Q4 2026', year:'Upcoming Operations',
...
export interface CouncilMember {
  id:string; initial:string; name:string; role:string; bio:string; classified?:boolean
}

export const council: CouncilMember[] = [
  { id:'ali', initial:'A', name:'Ali', role:'Founder · Lead Architect',
  ...
  { id:'neil', initial:'N', name:'Neil', role:'Strategic Partner · Product Vision',
  ...
  { id:'leo', initial:'L', name:'Leo', role:'Operations Partner',
  ...
  { id:'classified', initial:'?', name:'Classified', role:'Undisclosed · The System',
